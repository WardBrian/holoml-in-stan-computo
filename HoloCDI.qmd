...
<!-- BMW: clarify that this is for the constrained model? -->
...
Sampling is run in the same way as Pathfinder, with draws being extracted and averaged to create the estimate.
